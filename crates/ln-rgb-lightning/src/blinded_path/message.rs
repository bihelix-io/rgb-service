...
impl BlindedMessagePath {
        ...
        ES::Target: EntropySource,
    {
        let introduction_node = IntroductionNode::NodeId(
            intermediate_nodes
                .first()
                .map_or(recipient_node_id, |n| n.node_id),
        );
...
pub(super) fn blinded_hops<T: secp256k1::Signing + secp256k1::Verification>(
    ...
    let is_compact = intermediate_nodes
        .iter()
        .any(|node| node.short_channel_id.is_some());
    ...
    let tlvs = pks
        ...
        .chain(core::iter::once(ControlTlvs::Receive(ReceiveTlvs {
