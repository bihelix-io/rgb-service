...
impl ProbabilisticScoringFeeParameters {
    ...
    pub fn add_banned(&mut self, node_id: &NodeId) {
        self.manual_node_penalties
            .insert(*node_id, u64::max_value());
    }
    ...
    L::Target: Logger,
{
    ...
    fn with_channel(mut self, short_channel_id: u64, liquidity: ChannelLiquidity) -> Self {
        assert!(self
            .channel_liquidities
            .insert(short_channel_id, liquidity)
            .is_none());
        self
    }
...
impl ChannelLiquidity {
    ...
    fn decayed_offset(
        ...
        if half_life != 0.0 {
            let elapsed_time = duration_since_epoch
        ...
        self.liquidity_history.track_datapoint(
            *self.min_liquidity_offset_msat + bucket_offset_msat,
            self.max_liquidity_offset_msat
                .saturating_sub(bucket_offset_msat),
            self.capacity_msat,
        );
    ...
    L::Target: Logger,
{
    ...
    fn time_passed(&mut self, duration_since_epoch: Duration) {
        self.channel_liquidities
            .time_passed(duration_since_epoch, self.decay_params);
        self.last_update_time = duration_since_epoch;
    }
}
    ...
    L::Target: Logger,
{
    ...
    pub fn merge(
        &mut self,
        mut external_scores: ChannelLiquidities,
        duration_since_epoch: Duration,
    ) {
...
mod bucketed_history {
    ...
    impl_writeable_tlv_based!(LegacyHistoricalBucketRangeTracker, {
        (0, buckets, required)
    });
    ...
    impl HistoricalLiquidityTracker {
        ...
        pub fn merge(&mut self, other: &Self) {
            self.min_liquidity_offset_history
                .merge(&other.min_liquidity_offset_history);
            self.max_liquidity_offset_history
                .merge(&other.max_liquidity_offset_history);
            self.recalculate_valid_point_count();
        }
    }
...
mod tests {
    ...
    fn update_channel(
        network_graph: &mut NetworkGraph<&TestLogger>,
        short_channel_id: u64,
        node_key: SecretKey,
        channel_flags: u8,
    ...
    fn combined_scorer() {
        ...
        let liquidity_range = combined_scorer
            .scorer
