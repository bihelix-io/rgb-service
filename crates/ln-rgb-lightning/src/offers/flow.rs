    ...
    L::Target: Logger,
{
    ...
    pub fn enqueue_held_htlc_available(
        &self,
        invoice: &StaticInvoice,
        reply_path_params: HeldHtlcReplyPath,
    ) -> Result<(), Bolt12SemanticError> {
        ...
        log_trace!(
            ...
            if reply_path_terminates_at_us {
                "our node"
            } else {
                "our always-online counterparty"
            }
        );
    ...
    pub fn handle_offer_paths_request(
        ...
        let offer_paths_om = OfferPaths {
            paths: offer_paths,
            paths_absolute_expiry: Some(paths_expiry.as_secs()),
        };
    ...
    pub fn verify_serve_static_invoice_message(
        ...
        if message
            .invoice
            .is_expired_no_std(self.duration_since_epoch())
        {
