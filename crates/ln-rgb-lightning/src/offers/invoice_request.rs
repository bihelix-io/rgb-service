...
mod tests {
    ...
    fn builds_invoice_request_with_defaults() {
        ...
        assert_eq!(
            invoice_request.issuer_signing_pubkey(),
        ...
        assert_eq!(
            invoice_request.invoice_request_features(),
        ...
        assert_eq!(
            ...
            (
                ...
                SignatureTlvStreamRef {
                    signature: Some(&invoice_request.signature())
                },
                ExperimentalOfferTlvStreamRef {
    ...
    fn builds_invoice_request_with_derived_payer_signing_pubkey() {
        ...
        (&tlv_stream, &experimental_tlv_stream)
            .write(&mut bytes)
            .unwrap();
    ...
    fn builds_invoice_request_with_features() {
        ...
        assert_eq!(
            invoice_request.invoice_request_features(),
            &InvoiceRequestFeatures::unknown()
        );
        assert_eq!(
            tlv_stream.features,
            Some(&InvoiceRequestFeatures::unknown())
        );
