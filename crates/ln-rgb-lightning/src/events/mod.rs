...
impl PaymentPurpose {
    ...
    pub(crate) fn from_parts(
        ...
        match payment_context {
            None => Ok(PaymentPurpose::Bolt11InvoicePayment {
                payment_preimage,
                payment_secret,
            }),
...
impl core::fmt::Display for ClosureReason {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> Result<(), core::fmt::Error> {
        ...
        match self {
            ClosureReason::CounterpartyForceClosed { peer_msg } => f.write_fmt(format_args!(
                "counterparty force-closed with message: {}",
                peer_msg
            )),
...
pub enum PaymentFailureReason {
    ...
    #[cfg_attr(
        feature = "std",
        doc = "exhausted the [`Retry::Timeout`] if the user set one."
    )]
    #[cfg_attr(
        not(feature = "std"),
    ...
    fn write<W: Writer>(&self, writer: &mut W) -> Result<(), io::Error> {
        match self {
            ...
            &Event::HTLCIntercepted {
                ...
                6u8.write(writer)?;
                let intercept_scid = InterceptNextHop::FakeScid {
                    requested_next_hop_scid,
                };
                write_tlv_fields!(writer, {
    ...
    fn read<R: io::Read>(reader: &mut R) -> Result<Option<Self>, msgs::DecodeError> {
        match Readable::read(reader)? {
            ...
            6u8 => {
                ...
                let mut requested_next_hop_scid = InterceptNextHop::FakeScid {
                    requested_next_hop_scid: 0,
                };
