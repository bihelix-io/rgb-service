...
mod test {
    ...
    #[test]
    fn startup_rna_supply_contract_validates() {
        let terms = ContractTerms {
            text: RicardianContract::default(),
            media: None,
        };
        let spec = AssetSpec {
            ticker: Ticker::from("RNA"),
            name: Name::from("RNA"),
            details: None,
            precision: Precision::try_from(8).unwrap(),
        };
        let issued_supply = 100_000_000_000_000_000u64;
        let seal: BlindSeal<Txid> = GenesisSeal::from(BlindSeal::with_blinding(
            Txid::from_str("8d54c98d4c29a1ec4fd90635f543f0f7a871a78eb6a6e706342f831d92e3ba19")
                .unwrap(),
            0,
